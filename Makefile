...
# will be built.
MESOS_VERSIONS := 0.26.0 0.27.2 0.28.1
...
ISO_VERSIONS := 0.26.0 0.27.2 0.28.1
...
DEPS_URL := https://dl.bintray.com/emccode/mesos-module-libstorage/ubuntu-12.04-build-deps
...
ISO_SRC_LIB_$1 := $$(ISO_LIBDIR_$1)/libmesos_libstorage_isolator-$$(ISO_VER_$1).so
...
$$(ISO_SRC_LIB_$1):
	docker run -ti -v $$(PWD):/isolator emccode/mesos-module-libstorage-dev:$1
else
